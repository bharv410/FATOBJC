...
- (void)viewDidLoad {
    ...
    UIView *whiteBackgrouond =[[UIView alloc]initWithFrame:self.view.bounds];
    
//    UIView *texturedBackgroundView = [[UIView alloc] initWithFrame:self.view.bounds];
//    [texturedBackgroundView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"BackgroundLeather.png"]]];
    self.tableView.backgroundView = whiteBackgrouond;

    //set title
    UILabel *titleLabel =[[UILabel alloc]init];
    titleLabel.text=@"Find A Trainer";
    titleLabel.textColor=[UIColor colorWithRed:92.0f/255.0f green:173.0f/255.0f blue:255.0f/255.0f alpha:1.0f];
